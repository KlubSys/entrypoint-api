...
public class JobSchedulerApi {
    ...
    public SubmitDecompositionJobApiResponse submitJob(SubmitFileDecompositionJobMessage message) throws Exception {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            SubmitDecompositionJobApiResponse content = defaultMapper.readValue(
                    bdy, SubmitDecompositionJobApiResponse.class);
